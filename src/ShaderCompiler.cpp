...
bool ShaderCompiler::CompilePixelShader(LPCWSTR filepath, IDxcBlob** ppShaderOut)
{
    //
    // COMMAND LINE:
    ...
    return CompileShader(_countof(pszArgs), pszArgs, ppShaderOut);
}

bool ShaderCompiler::CompileShader(size_t numArgs, LPCWSTR* pszArgs, IDxcBlob** ppShaderOut)
{
